...
var config = {
    ...
    // websocketKeepAliveUrl: 'https://alpha.jitsi.net/' + subdir + '_unlock',
    ...
    // focusUserJid: 'focus@auth.alpha.jitsi.net',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="alpha.jitsi.net" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://alpha.jitsi.net/static/oauth.html'
    //     redirectURI:
    //          'https://alpha.jitsi.net/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:alpha.jitsi.net:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.alpha.jitsi.net',
