...
import { isLocalParticipantColHost, isLocalParticipantModerator } from '../../../base/participants/functions';
...
export const EndConferenceButton = (props: IProps) => {
    ...
    const _isLocalParticipantColHost = useSelector(isLocalParticipantColHost);
    ...
    return (<>
        { !_isInBreakoutRoom && _isLocalParticipantModerator && !_isLocalParticipantColHost && <HangupContextMenuItem
